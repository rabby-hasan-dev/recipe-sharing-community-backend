...
const followUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield follow_service_1.followServices.followUserIntoDB(currentUserId, userToFollowId);
...
const unfollowUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const currentUserId = (_a = req === null || req === void 0 ? void 0 : req.user) === null || _a === void 0 ? void 0 : _a.userId;
    const userToFollowId = req.params.userId;
    const result = yield follow_service_1.followServices.UnfollowUserIntoDB(currentUserId, userToFollowId);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
